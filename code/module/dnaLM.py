...
class DNALM():
    def __init__(self, modelName, splitGene, batchSize=64):
    ...
    def loadModel(self):
        self.model = transformers.AutoModelForSequenceClassification.from_pretrained(self.modelName,
    ...
    def runModel(self):
        def tokenize_function(dna):
            return self.tokenizer(dna, return_tensors = 'pt', padding=True)["input_ids"]
